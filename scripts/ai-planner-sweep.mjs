...
const LAYOUT_FILES = ['types','versions','schemas','geometry','briefConstraints','polygon','catalogRoles','solveRun','compileSpec','rules','validate','defaultSpec','priceDesign','wizardAdapter','proposalState','designScore','candidateGenerator','index'];
