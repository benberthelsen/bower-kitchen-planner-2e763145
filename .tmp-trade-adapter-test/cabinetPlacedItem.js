...
exports.toPlacedItems = toPlacedItems;
exports.categoryForDefinition = categoryForDefinition;
function toPlacedItems(cabinets, materialDefaults) {
...
function categoryForDefinition(definitionId) {
    if (definitionId.includes('opening'))
        return 'Appliance';
    if (definitionId.startsWith('wall_') || definitionId === 'fridge_top_cabinet')
        return 'Wall';
    if (definitionId.startsWith('tall_'))
        return 'Tall';
    return 'Base';
}
