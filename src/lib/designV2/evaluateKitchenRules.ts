...
const VIOLATION_RULES: Record<string, { ruleId: string; stage: 'concept' | 'quote'; severity: 'blocker' | 'warning' | 'advisory' }> = {
  ...
  'allowed-wall': { ruleId: 'KRN-ROOM-001', stage: 'concept', severity: 'blocker' },
  'selected-wall-missing': { ruleId: 'KRN-ROOM-001', stage: 'concept', severity: 'blocker' },
  'wall-run-range': { ruleId: 'KRN-ROOM-001', stage: 'concept', severity: 'blocker' },
  'duplicate-run-wall': { ruleId: 'KRN-ROOM-001', stage: 'concept', severity: 'blocker' },
  ...
  'cooktop-window': { ruleId: 'KRN-APPL-002', stage: 'concept', severity: 'warning' },
  ...
  'tall-unit-run-end': { ruleId: 'KRN-TALL-001', stage: 'concept', severity: 'blocker' },
  'tall-unit-workflow-break': { ruleId: 'KRN-TALL-001', stage: 'concept', severity: 'blocker' },
  'tall-unit-cluster': { ruleId: 'KRN-TALL-001', stage: 'concept', severity: 'blocker' },
  'wall-end-filler': { ruleId: 'KRN-JOIN-001', stage: 'concept', severity: 'blocker' },
  'corner-integrity': { ruleId: 'KRN-CORNER-001', stage: 'concept', severity: 'blocker' },
  'corner-resolution': { ruleId: 'KRN-CORNER-001', stage: 'concept', severity: 'blocker' },
  'blind-corner-join': { ruleId: 'KRN-CORNER-001', stage: 'concept', severity: 'blocker' },
  'cooking-appliance-corner-clearance': { ruleId: 'KRN-CORNER-001', stage: 'concept', severity: 'blocker' },
  'fridge-room-corner-clearance': { ruleId: 'KRN-FRIDGE-001', stage: 'concept', severity: 'blocker' },
  'style-composition-fidelity': { ruleId: 'KRN-STYLE-001', stage: 'concept', severity: 'blocker' },
  'oven-housing-fit': { ruleId: 'KRN-APPL-002', stage: 'concept', severity: 'blocker' },
  ...
  'fridge-landing': { ruleId: 'KRN-BENCH-001', stage: 'concept', severity: 'warning' },
  'prep-space': { ruleId: 'KRN-BENCH-001', stage: 'concept', severity: 'warning' },
  'sink-side-clearance': { ruleId: 'KRN-BENCH-001', stage: 'concept', severity: 'warning' },
  ...
  'triangle-obstruction': { ruleId: 'KRN-FLOW-001', stage: 'concept', severity: 'blocker' },
};
