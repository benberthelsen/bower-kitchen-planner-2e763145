...
import { BLIND_CORNER_CLEARANCE_MM, BLIND_CORNER_MIN_WIDTH_MM } from './blindCorner';
import type { KitchenSpec, ResolvedSegment, RoomSpec, Run, SegmentRole, Wall } from './types';
